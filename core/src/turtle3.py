...
#
# ====
# minor edits to the original turtle.py file to permit multiple screens running at the same time
# ====
...
class TurtleScreenBase(object):
    ...
    def _imageFromPixels(self, pixelImage):
        ...
        """
        #print((pixelImage.width, self.xscale, pixelImage.height, self.yscale))
        img = pixelImage.resize((pixelImage.width, pixelImage.height)) # * self.xscale, pixelImage.height * self.yscale)
...
##        """may be implemented for some other graphics toolkit"""
    ...
    def _createimage(self, image):
        ...
        """
        return self.cv.create_image(0, 0, anchor="sw", image=image)
